...
export interface ProjectTimelockInterface extends utils.Interface {
  functions: {
...
export interface ProjectTimelock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProjectTimelockInterface;
