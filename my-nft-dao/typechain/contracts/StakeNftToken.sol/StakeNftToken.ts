...
export interface StakeNftTokenInterface extends utils.Interface {
  functions: {
    ...
    "releaseFunds(address,uint256)": FunctionFragment;
...
export interface StakeNftToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeNftTokenInterface;
